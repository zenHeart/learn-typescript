...
1. 类型系统
   ...
   3. 接口类型
      ...
      2. 采用 `readonly` 修饰只读参数
         1.  `ReadonlyArray<T>` 修饰只读数组
         2.  使用 const 和 readonly 的选择 <https://www.typescriptlang.org/v2/docs/handbook/interfaces.html#readonly-vs-const>
             1.  变量 const
             2.  属性 readonly
...
5. 类型推导 https://www.typescriptlang.org/v2/docs/handbook/type-inference.html
